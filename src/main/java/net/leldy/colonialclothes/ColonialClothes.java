...
@Mod(ColonialClothes.MODID)
public class ColonialClothes {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "leldyscolonialclothes";
    ...
    @EventBusSubscriber(modid = ColonialClothes.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
